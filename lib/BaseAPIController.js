...
class BaseAPIController {
    constructor(cors_enabled, auth_enabled, auth_token) {
        this.cors_enabled = cors_enabled;
        this.auth_enabled = auth_enabled;
        this.auth_token = auth_token;
    }

    isValidRequest(req, requiredKeys){
        var notExistKeys = [];
    ...
    throwException(res, code, message)
    {
...
global.BaseAPIController = BaseAPIController;
